...
- [Browser Setup](./getting-started/browser-setup.md)
- [Configuration](./getting-started/configuration.md)

# Core Tools

- [Proxy](./core/proxy.md)
- [Intercept](./core/intercept.md)
- [Repeater](./core/repeater.md)
- [Intruder](./core/intruder.md)
...
- [Active Scanner (vurl)](./scanning/vurl.md)

# Intelligence

- [Nerve — Passive Analysis](./intelligence/nerve.md)
...
- [Lua Plugins](./extensibility/lua-plugins.md)
- [MCP Integration](./extensibility/mcp.md)
- [Plugin SDK](./extensibility/plugin-sdk.md)
